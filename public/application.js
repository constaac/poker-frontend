...
/***/ (function(module, exports, __webpack_require__) {
	...
	var trackerEvents = __webpack_require__(14);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onLogout = function onLogout(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.logout(data).then(ui.logoutSuccess).catch(ui.logoutFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var trackerlogic = __webpack_require__(12);
	...
	var onClosePasswordPrompt = function onClosePasswordPrompt() {
	  $('.passwordstatus').text('');
	};

	var onCloseLoginPrompt = function onCloseLoginPrompt() {
	  $('.signinstatus').text('');
	};

	var onCloseSignupPrompt = function onCloseSignupPrompt() {
	  $('.signupstatus').text('');
	};
	...
	module.exports = {
	  ...
	  onClosePasswordPrompt: onClosePasswordPrompt,
	  onCloseLoginPrompt: onCloseLoginPrompt,
	  onCloseSignupPrompt: onCloseSignupPrompt
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var makePlayers = function makePlayers() {
	  for (var i = 1; i <= 10; i++) {
	...
	var phases = ['Pre-Flop', 'Flop', 'Turn', 'River'];
	...
	var checkSittingPlayers = function checkSittingPlayers() {
	...
	var resetPlayer = function resetPlayer(x) {
	  var seat = game['p' + x];
	  seat.id = undefined;
	  seat.name = 'Player ' + x;
	...
	var resetAllPlayers = function resetAllPlayers() {
	  for (var i = 1; i <= 10; i++) {
	    var seat = game['p' + i];
	    seat.id = undefined;
	    seat.name = 'Player ' + i;
	...
	var toggleGameButtons = function toggleGameButtons() {
	  if (game.active) {
	...
	var checkEndOfArray = function checkEndOfArray(x) {
	...
	var calcBlinds = function calcBlinds() {
	  var startPosition = void 0;
	  for (var i = 0; i < game.playing.length; i++) {
	    if (game.playing[i].is_dealer) {
	      startPosition = i;
	    }
	  }
	  var smallBlind = startPosition + 1;
	  ...
	  if (game.playing.length > 2) {
	    ...
	    var tempFirstToBet = players.find(function (element) {
	      return element === game.playing[currentMove];
	    });
	    ...
	    var _tempFirstToBet = players.find(function (element) {
	      return element === game.playing[startPosition];
	    });
	    game.first_to_bet = _tempFirstToBet;
	...
	var displayDealerMenu = function displayDealerMenu() {
	  $('.dealer-menu').empty();
	  ...
	  var _loop = function _loop(i) {
	    ...
	    if (game['p' + i].playing) {
	      ...
	      $('#set-dealer-' + i).on('click', function () {
	...
	var onStartRound = function onStartRound() {
	  for (var j = 1; j <= 10; j++) {
	    if (game['p' + j].playing) {
	...
	var setCurrentMove = function setCurrentMove(x) {
	  var currentMoveHolder = x + 1;
	  if (currentMoveHolder === game.playing.length) {
	    currentMoveHolder = 0;
	  }
	  game.current_move_index = currentMoveHolder;
	  var tempCurrentPlayer = players.find(function (element) {
	    return element === game.playing[currentMoveHolder];
	  });
	  game.current_move = tempCurrentPlayer;
	};

	var setPersonalBetCountsZero = function setPersonalBetCountsZero() {
	  for (var i = 1; i < 11; i++) {
	    game['p' + i].personal_bet_count = 0;
	  }
	};

	var setCurrentBet = function setCurrentBet(condition) {
	...
	var resetTempStat = function resetTempStat() {
	  for (var i = 1; i <= 10; i++) {
	    var player = game['p' + i];
	...
	var addTempToStat = function addTempToStat() {
	  for (var i = 1; i <= 10; i++) {
	    var player = game['p' + i];
	...
	var incrementPhase = function incrementPhase(condition) {
	  if (condition) {
	    game.phase_count = 0;
	    game.phase = phases[0];
	    setCurrentBet();
	    ...
	    var tempFirstToBetIndex = game.playing.findIndex(function (element) {
	      return element === game.current_move;
	    });
	...
	var checkPossible = function checkPossible() {
	...
	var betPossible = function betPossible() {
	  if (game.current_move.personal_bet_count <= game.current_bet_count) {
	    return true;
	  } else {
	    return false;
	...
	var callPossible = function callPossible() {
	  if (game.current_move.personal_bet_count < game.current_bet_count) {
	    return true;
	  } else {
	    return false;
	...
	var positionBehindBigBlind = function positionBehindBigBlind() {
	  var bigBlindIndex = game.playing.findIndex(function (element) {
	    return element === game.big_blind;
	  });
	...
	var allCalled = function allCalled() {
	...
	var testRaise = function testRaise() {
	  if (game.current_move.personal_bet_count < game.current_bet_count) {
	    return true;
	  }
	};
	...
	var testReRaise = function testReRaise() {
	...
	var testVPIP = function testVPIP() {
	...
	var test3BetReRaise = function test3BetReRaise() {
	...
	var test3BetCallToRaise = function test3BetCallToRaise() {
	...
	var fold = function fold() {
	  var index = game.playing.findIndex(function (element) {
	    return element === game.current_move;
	  });
	...
	var resetHasRaisedOrCalledPreflop = function resetHasRaisedOrCalledPreflop() {
	...
	var triggerEndOfRound = function triggerEndOfRound(condition) {
	  for (var t = 1; t < 11; t++) {
	    if (game['p' + t].playing) {
	  ...
	  $('#set-table-btn').on('click', function () {
	...
	var teststats = function teststats() {
	  $('#stats-table').empty();
	  $('#stats-table').append('<thead><tr><th>Name</th><th>Hands Seen</th><th>VPIP %</th><th>PFR %</th></tr></thead>');
	  for (var i = 0; i < players.length; i++) {
	    if (players[i].sitting) {
	      var totalHands = players[i].hand_count + players[i].hand_count_career;
	      if (totalHands === 0) {
	        $('#stats-table').append('<tr><td>' + $('#playername' + (i + 1)).val() + '</td><td>' + totalHands + '</td><td>0.0</td><td>0.0</td></tr>');
	      } else {
	        var totalRaisesOrCallsPF = players[i].call_or_raise_preflop + players[i].call_or_raise_preflop_career;
	        var totalRaisesPF = players[i].raise_preflop + players[i].raise_preflop_career;
	        var totalReRaisePF = players[i].reraise_preflop + players[i].reraise_preflop_career;
	        var totalCallToRaisePF = players[i].call_to_raise_preflop + players[i].call_to_raise_preflop_career;
	        var VPIP = (totalRaisesOrCallsPF / totalHands * 100).toFixed(1);
	        var PFR = (totalRaisesPF / totalHands * 100).toFixed(1);
	        var ThreeBetPF = (totalReRaisePF / (totalReRaisePF + totalCallToRaisePF) * 100).toFixed(1);
	...
	module.exports = {
	  ...
	  teststats: teststats,
	  call: call,
	  betPossible: betPossible,
	  checkPossible: checkPossible,
	  callPossible: callPossible,
	  setCurrentMove: setCurrentMove,
	  setCurrentBet: setCurrentBet,
	  setPersonalBetCountsZero: setPersonalBetCountsZero,
	  incrementPhase: incrementPhase,
	  triggerEndOfRound: triggerEndOfRound,
	  allCalled: allCalled,
	  positionBehindBigBlind: positionBehindBigBlind,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var checkPlayerNameChanged = function checkPlayerNameChanged(seatID) {
	  if ($('#playername' + seatID).val() === 'Player ' + seatID) {
	    return true;
	  }
	};

	var failure = function failure(string) {
	...
	var checkEmptyPlayerName = function checkEmptyPlayerName(seatID) {
	...
	var onSaveButton = function onSaveButton() {
	  var seatID = $('#seat-selector').val();
	  if (checkEmptyPlayerName(seatID)) {
	    return;
	  }
	  var data = { player: {} };
	  var player = logic.game['p' + seatID];
	  var handCount = player.hand_count + player.hand_count_career;
	  var callPreflop = player.call_preflop + player.call_preflop_career;
	  var raisePreflop = player.raise_preflop + player.raise_preflop_career;
	  var callOrRaisePreflop = player.call_or_raise_preflop + player.call_or_raise_preflop_career;
	  var reraisePreflop = player.reraise_preflop + player.reraise_preflop_career;
	  var callToRaisePreflop = player.call_to_raise_preflop + player.call_to_raise_preflop_career;
	  var foldOnReraisePreflop = player.fold_on_reraise_preflop + player.fold_on_reraise_preflop_career;
	  var temp = data.player;
	  ...
	  api.save(data).then(ui.onSaveSuccess).catch(ui.onSaveFailure);
	};

	var onLoadButton = function onLoadButton() {
	  var seatID = $('#seat-selector').val();
	  if (checkEmptyPlayerName(seatID)) {
	    return;
	  }
	  var data = { player: {} };
	  var player = $('#playername' + seatID).val();
	  var temp = data.player;
	  temp.name = player;
	  api.load(data).then(ui.onLoadSuccess).catch(ui.onLoadFailure);
	};

	var onDeleteButton = function onDeleteButton() {
	  var seatID = $('#seat-selector').val();
	  if (logic.game['p' + seatID].is_user) {
	    failure("You can't delete your own statistics");
	    return;
	  }
	  var playerID = logic.game['p' + seatID].id;
	  if (playerID === undefined) {
	    failure("Player doesn't exist on the server");
	    return;
	  }
	  api.destroy(playerID).then(ui.onDeleteSuccess).catch(ui.onDeleteFailure);
	};

	var onIndexButton = function onIndexButton() {
	  api.index().then(ui.onIndexSuccess).catch(ui.onIndexFailure);
	};

	var addHandlers = function addHandlers() {
	  var _loop = function _loop(j) {
	    $('#seat-button-' + j).on('click', function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var setSeatsNumber = __webpack_require__(16);
	var logic = __webpack_require__(12);
	var store = __webpack_require__(10);
	var api = __webpack_require__(36);

	var success = function success(string) {
	  $('#error-indicator').html(string);
	...
	var setOnCheckBox = function setOnCheckBox(x) {
	  var _loop = function _loop(i) {
	...
	var setOnCheckRadio = function setOnCheckRadio(x) {
	  var _loop2 = function _loop2(i) {
	    $('#radio' + i).change(function () {
	      ...
	      if (this.checked) {
	        ...
	        api.load(data).then(function (response) {
	          logic.resetPlayer(i);
	          var person = logic.game['p' + i];
	          var holder = response.player;
	          person.id = holder.id;
	...
	var onSetSeatButton = function onSetSeatButton(count) {
	  ...
	  var showSeatsHtml = setSeatsNumber({ list: tempArray });
	  $('#seats-table').empty();
	...
	var onSaveSuccess = function onSaveSuccess(response) {
	  var seatNumber = $('#seat-selector').val();
	...
	var onSaveFailure = function onSaveFailure() {
	  failure('Player save failed!');
	};

	var onLoadSuccess = function onLoadSuccess(response) {
	  var seatNumber = $('#seat-selector').val();
	  logic.resetPlayer(seatNumber);
	  var person = logic.game['p' + seatNumber];
	  var holder = response.player;
	  person.id = holder.id;
	...
	var onLoadFailure = function onLoadFailure() {
	...
	var onDeleteFailure = function onDeleteFailure() {
	  failure('Player not found!');
	};

	var onIndexSuccess = function onIndexSuccess(response) {
	  var sortedArray = response.players;
	  var userNameIndex = NaN;
	...
	var onListHide = function onListHide() {
	...
	var onIndexFailure = function onIndexFailure() {
	  failure('Error Loading List');
	  $('#player-index-container').css('display', 'none');
	};

	module.exports = {
	  onSetSeatButton: onSetSeatButton,
	  openSetSeats: openSetSeats,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td>\n        "
	    ...
	    + "\n      </td>\n      <td>\n        <input type=\"text\" class=\"input-query\" id=\"playername"
	    + alias2(alias1(blockParams[0][0], depth0))
	    + "\" value=\"Player "
	    + alias2(alias1(blockParams[0][0], depth0))
	  ...
	  return "<table style=\"width:100%\" class=\"table\">\n  <tr>\n    <th>Seat #</th>\n    <th>Name</th>\n    <th>Sitting</th>\n    <th>User</th>\n  </tr>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.list : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n";
